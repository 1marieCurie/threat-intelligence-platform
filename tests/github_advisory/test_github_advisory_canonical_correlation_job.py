...
@dataclass
class FakeGitHubAdvisoryCanonicalBatchProcessor:
    results: deque[
        GitHubAdvisoryCanonicalCorrelationBatchResult
    ]
    ...
    calls: list[
        tuple[
            GitHubAdvisoryCanonicalCursor | None,
            int,
        ]
    ] = field(
...
class FailingGitHubAdvisoryCanonicalBatchProcessor:
    def process_batch(
        self,
        *,
        after_cursor: (
...
def test_rejects_invalid_batch_size(
    ...
    processor = (
        FakeGitHubAdvisoryCanonicalBatchProcessor(
            results=deque()
        )
    )
...
def test_sanitizes_secrets_before_logging(
    ...
    job = (
        GitHubAdvisoryCanonicalCorrelationJob(
            processor=(
                FailingGitHubAdvisoryCanonicalBatchProcessor()
            ),
            logger=logger,
        )
    )
