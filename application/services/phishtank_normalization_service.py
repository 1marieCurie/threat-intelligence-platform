...
class PhishTankNormalizationResult:
    claimed: int
    normalized: int
...
class PhishTankNormalizationService:
    """
    Normalise les payloads PhishTank déjà persistés.

    Le service ne contacte jamais PhishTank directement.
    Il travaille uniquement avec les données de la couche brute.
    """
    ...
    def __init__(
        ...
        *,
        ...
        normalizer: PhishTankNormalizer,
    ...
    def _build_error_message(
        ...
        if isinstance(
            ...
            # Une exception SQLAlchemy peut contenir
            # les paramètres SQL et donc l'URL IOC.
            # On conserve uniquement le type d'erreur.
            raw_message = (
                f"{error_type}: "
