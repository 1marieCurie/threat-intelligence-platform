...
class GitHubAdvisoryCanonicalBatchProcessor(
    Protocol
):
    """
    Port minimal utilisé par le job GitHub Advisory.
...
class GitHubAdvisoryCanonicalCorrelationJobResult:
...
class _GitHubAdvisoryJobCounters:
...
class GitHubAdvisoryCanonicalCorrelationJob:
    """
    Enchaîne les lots canoniques GitHub Advisory.
    ...
    def __init__(
        ...
        *,
        processor: (
            GitHubAdvisoryCanonicalBatchProcessor
        ),
    ...
    def run(
        ...
        *,
        ...
        GitHubAdvisoryCanonicalCorrelationJobResult
    ):
        counters = (
            _GitHubAdvisoryJobCounters()
        )
    ...
    def _build_result(
        *,
        counters: _GitHubAdvisoryJobCounters,
        next_cursor: (
            GitHubAdvisoryCanonicalCursor
            | None
        ),
